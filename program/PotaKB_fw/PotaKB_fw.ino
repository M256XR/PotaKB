...
for(int r=0; r<ROWS; r++) { for(int c=0; c<COLS; c++) { matrix_to_layout_index[r][c] = -1; } }
  // ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
  // ★★★ 回路図の Col を 行(row)、Raw を 列(col) として再定義した正しいマッピング (v2) ★★★
  // ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
  const uint8_t sw_to_matrix[64][2] = {
    // スイッチ番号 - 1 = { Col番号, Raw番号 }
    /* SW1-8 */   {0,0}, {0,1}, {0,2}, {0,3}, {1,1}, {1,2}, {1,3}, {0,4},
    /* SW9-16 */  {2,1}, {2,2}, {2,3}, {1,4}, {3,1}, {3,2}, {3,3}, {2,4},
    /* SW17-24 */ {4,1}, {4,2}, {4,3}, {3,4}, {5,1}, {5,2}, {5,3}, {4,4},
    /* SW25-32 */ {6,1}, {6,2}, {6,3}, {5,4}, {4,5}, {7,1}, {7,2}, {7,3},
    /* SW33-40 */ {6,4}, {5,5}, {1,0}, {1,5}, {3,6}, {7,4}, {6,5}, {2,0},
    /* SW41-48 */ {2,5}, {0,7}, {4,7}, {4,6}, {3,0}, {3,5}, {1,7}, {5,7},
    /* SW49-56 */ {5,6}, {4,0}, {0,6}, {2,7}, {6,7}, {6,6}, {5,0}, {1,6},
    /* SW57-64 */ {7,5}, {7,7}, {6,0}, {2,6}, {3,7}, {7,0}, {0,5}, {0,0} // SW64はダミー
  };
  const uint8_t physical_layout_order[] = { 1, 62, 
                                            2, 5, 9, 13, 17, 21, 25, 30, 35, 40, 45, 50, 55, 59, 63, 
